...
```javascript
import mskmidrange from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-mskmidrange@v0.1.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-mskmidrange@v0.1.1-deno/mod.js';
```
